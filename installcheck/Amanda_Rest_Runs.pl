                                                   ...
                                                   'localhost' => {
                                                                    '/etc' => {
                                                                                '20090410074759' => {
                                                                                                      ...
                                                                                                      'partial' => 1,
                                                                                                      'size' => '82859008',
                                                                                                      'message' => 'dump failed: [/usr/sbin/tar returned error]',
                                                                                                      'esize' => '82761728',
                                                                                                      'level' => '0',
												      'retry' => 0,
												      'retry_level' => -1,
												      'will_retry' => 0,
                                                                                                      'flush' => 0,
                                                                                                      'holding_file' => '@amandastatedir@/staging/20090410074759/localhost._etc.0',
                                                                                                      'error' => '[/usr/sbin/tar returned error]',
                                                                                                      'chunk_time' => '84.745',
                                                                                                      'dsize' => '82859008',
                                                                                                      'storage' => {
                                                                                                                     'TESTCONF' => {
